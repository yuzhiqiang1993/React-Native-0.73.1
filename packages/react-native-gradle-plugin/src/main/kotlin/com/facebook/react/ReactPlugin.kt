    ...
    private fun configureCodegen(
        ...
        val generateCodegenSchemaTask =
            project.tasks.register(
                ...
                println("Package plugin generateCodegenSchemaFromJavaScript 执行,isLibrary: $isLibrary")
                it.nodeExecutableAndArgs.set(rootExtension.nodeExecutableAndArgs)
                it.codegenDir.set(rootExtension.codegenDir)
                println("Package plugin set codegenDir: ${rootExtension.codegenDir.get()}")
                it.generatedSrcDir.set(generatedSrcDir)
                println("Package plugin set generatedSrcDir: ${generatedSrcDir.get()}")
        ...
        val generateCodegenArtifactsTask =
            project.tasks.register(
                ...
                println("Package plugin generateCodegenArtifactsFromSchema 执行,isLibrary: $isLibrary")
